      ...
      <div className="homePage">
        ...
        <div className="card-container">
          <section className="card">
            ...
            <img className="card-image" src="/images/random farm house.jpg" alt="Homesite" />
          ...
          <section className="card">
            ...
            <img className="card-image" src="/images/camping.jpg" alt="Recreation" />
            <div className="card-content">
          ...
          <section className="card">
            ...
            <img className="card-image" src="/images/rising_hand_stock.jpg" alt="Investment" />
            <div className="card-content">
          ...
          <section className="card">
            ...
            <img className="card-image" src="/images/commercial_investment_image.jpg" alt="Commercial Development" />
            <div className="card-content">

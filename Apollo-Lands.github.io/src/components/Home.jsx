export default function Home() {
  ...
  <section>
    <h3>Recreation: Create a Personal Playground</h3>
    <p>Land isn’t just a place to live; it’s also a place to play. Whether it’s:</p>
    <ul>
  ...
  <section>
    <h3>Agriculture: Grow Your Own Future</h3>
    <p>If you’ve ever dreamed of farming, land offers a blank slate to build your agricultural vision.</p>
    <ul>
      <li>Growing organic produce</li>
      <li>Raising livestock or poultry</li>
      <li>Starting a vineyard or orchard</li>
    </ul>
  </section>

  <section>
    <h3>Commercial Development: Build Something Bigger</h3>

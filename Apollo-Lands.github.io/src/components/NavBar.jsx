...
//       <Toolbar sx={{ minHeight: '90px' }}> {/* Adjust the height of the toolbar */}
//         {/* Left section: Apollo Lands Logo, Services, About */}
//         <Box sx={{ display: 'flex', flexGrow: 1, alignItems: 'center' }}>
//           {/* Apollo Lands Logo as an image */}
//           <Link to="/Home">
//             <img
//               src="/Apollo Lands Logo.png" // Relative path to your image in the public folder
//               alt="Apollo Lands Logo"
//               style={{ height: '160px', marginRight: '16px' }} // Increase the image height
//             />
//           </Link>

      ...
      <div className="homePage">
        ...
        <div className="card-container">
          <section className="card">
            ...
            <img className="card-image" src="/public/random farm house.jpg" alt="Homesite" />
          ...
          <section className="card">
            ...
            <img className="card-image" src="/public/rising_hand_stock.jpg" alt="Investment" />
            <div className="card-content">
          ...
          <section className="card">
            ...
            <img className="card-image" src="public/commercial_investment_image.jpg" alt="Commercial Development" />
            <div className="card-content">
